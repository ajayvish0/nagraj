...
const max = Math.max(
  ...[...counters].map((counter) => +counter.dataset.target)
);
...
const url =
  "https://script.google.com/macros/s/AKfycbynecsEBbTLrg2iTdwKrCjDKTRGpEiOYtj-yRWYY8Q_79zJv8CjUOoIkVBzs7VgbkfC5w/exec";
